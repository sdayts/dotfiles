(defun sd/delete-out-of-date-bytecode (directory)
  ...
  (dolist (path-and-attributes (directory-files-and-attributes directory t))
    (let ((path       (car path-and-attributes))
      ...
      (cond ((string-prefix-p "." (file-name-nondirectory path))
            ...
            ((car attributes)
             (sd/delete-out-of-date-bytecode path))
...
(sd/delete-out-of-date-bytecode
 (expand-file-name "sd" user-emacs-directory))
